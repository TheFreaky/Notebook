...
//    private Calendar finishDate;
    ...
    public Event(EventDataSet eventDataSet) {
        id = eventDataSet.getId();
        title = eventDataSet.getName();
        description = eventDataSet.getDescription();
        startDate = Calendar.getInstance();
        startDate.setTime(eventDataSet.getDate());
    }
